...
public final class NativeBridge {
    ...
    /** Sets the memory guard admission, operator, and critical thresholds (0.0–1.0). */
    public static void setMemoryGuardThresholds(double admission, double operator, double critical) {
        try {
            SET_MEMORY_GUARD_THRESHOLDS.invokeExact((long) (admission * 1000), (long) (operator * 1000), (long) (critical * 1000));
        } catch (Throwable t) {
