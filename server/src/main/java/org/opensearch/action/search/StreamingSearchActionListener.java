 ...
 */
abstract class StreamingSearchActionListener<T extends SearchPhaseResult> extends SearchActionListener<T> {

    protected StreamingSearchActionListener(SearchShardTarget searchShardTarget, int shardIndex) {
