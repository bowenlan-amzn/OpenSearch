 ...
 */
@ExperimentalApi
public class StreamChannelListener<Response extends TransportResponse, Request extends TransportRequest>
    implements
    ...
    public StreamChannelListener(TransportChannel channel, String actionName, Request request) {
