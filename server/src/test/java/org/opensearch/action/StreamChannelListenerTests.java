 ...
 */
public class StreamChannelListenerTests extends OpenSearchTestCase {
    ...
    private StreamChannelListener<TestResponse, TransportRequest> listener;

    @Before
    public void setUp() throws Exception {
        super.setUp();
        MockitoAnnotations.openMocks(this);
        listener = new StreamChannelListener<>(channel, "test-action", request);
    }
